...
export class ObservableComponent implements OnInit {
    ...
    mySubject() {
        ...
        mySubject.subscribe(this.observableA);
        mySubject.next(1);
        mySubject.next(2);
        mySubject.next(3);
        mySubject.subscribe(this.observableB);
    ...
    myReplaySubject() {
        ...
        myReplaySubject.subscribe(this.observableA);
        myReplaySubject.next(1);
        myReplaySubject.next(2);
        myReplaySubject.next(3);
        myReplaySubject.subscribe(this.observableB);
    ...
    myBehaviorSubject() {
        ...
        myBehaviorSubject.subscribe(this.observableA);
        myBehaviorSubject.next(1);
        myBehaviorSubject.next(2);
        myBehaviorSubject.next(3);
        myBehaviorSubject.subscribe(this.observableB);
